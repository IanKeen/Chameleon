...
public enum ChatPostMessageParseMode: String {
...
public enum ChatPostMessageOption {
    /// Specify the `ParseMode` to use for this message.
    case parse(ChatPostMessageParseMode)
...
extension ChatPostMessageOption: OptionRepresentable {
